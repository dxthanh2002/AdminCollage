    ...
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Feedbacks != null ? 
                          ...
                          Problem("Entity set 'DatabaseContext.Feedbacks'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Date,FirstQuestion,SecondQuestion,OtherQuestion,Status,CreatedAt,CreatedById,LastModifiedAt,LastModifiedBy")] Feedback feedback)
        {
            if (id != feedback.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseContext.Feedbacks'  is null.");
            }
            var feedback = await _context.Feedbacks.FindAsync(id);
            if (feedback != null)
            {
