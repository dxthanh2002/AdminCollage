...
namespace Admin.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,FatherName,MotherName,Dob,Gender,ResidentialAddress,PermanentAddress,AdmissionYear,AdmissionStream,StudentCode,PreviousEducationId,Status,CreatedAt,CreatedById,LastModifiedAt,LastModifiedBy")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
